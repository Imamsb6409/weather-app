    ...
    <div className="z-20 w-full md:w-1/3 md:max-w-sm p-6 md:p-8 flex flex-col bg-black/40 backdrop-blur-2xl border-b md:border-b-0 md:border-r border-white/5 shadow-2xl transition-colors duration-1000">
      ...
      <div className="relative mb-6 md:mb-10">
        <input
          ...
          className="w-full p-3 md:p-4 bg-white/5 border border-white/10 rounded-xl outline-none focus:border-cyan-400/50 focus:bg-white/10 transition-all backdrop-blur-md placeholder:text-white/20 text-sm"
        />
        {loading && (
